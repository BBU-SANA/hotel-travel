...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<script src="<?php echo base_url() ?>assets/admin/js/jquery-1.8.2.min.js" type="text/javascript"></script>
  ...
  return true;
    ...
    <link href="<?php echo base_url() ?>assets/admin/css/docs.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>assets/admin/js/google-code-prettify/prettify.css" rel="stylesheet">
